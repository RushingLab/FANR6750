...
#### We are interested in determining how urban development influences the abundance of strawberry poison-dart frogdata (*Oophaga pumilio*)
...
- Within each plot, strawberry frogdata are counted within 5 randomly-located quadrats 
...
- The `(Intercept)` estimate ( $\beta_0$ ) is the expected number of frogdata in a low-development plot
...
- **Question**: Are there fewer frogdata in high-development plots?
...
```{r echo = TRUE}
mu_high <- mean(frogdata$frogdata[frogdata$Development == "High"])
mu_low <- mean(frogdata$frogdata[frogdata$Development == "Low"])
