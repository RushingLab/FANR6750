...
ggplot(chuckdata, aes(x = moon, y = call.rate)) +
  ...
  annotate("text", label = "Intercept", x = 0.01, y = 3.35, hjust = 0, 
                                                   color = "#446E9B") +
  geom_segment(aes(y = 3.25, yend = 2.6, x = 0.025, xend = 0),
               arrow = arrow(length = unit(0.02, "npc")), color = "#446E9B") +
  annotate("text", label = "Intercept + cloud*0.5", x = 0.21, y = 2.65, hjust = 0, 
         color = "#D47500") +
  geom_segment(aes(y = 2.65, yend = 2.45, x = 0.2, xend = 0),
               arrow = arrow(length = unit(0.02, "npc")), color ="#D47500") +
  annotate("text", label = "Intercept + cloud*1", x = 0.21, y = 2, hjust = 0, 
         color = "#3CB521") +
  geom_segment(aes(y = 2, yend = 2.32, x = 0.2, xend = 0),
               arrow = arrow(length = unit(0.02, "npc")), color ="#3CB521") +
  annotate("text", label = "moon", x = 0.29, y = 4.22, hjust = 1, 
         color = "#446E9B") +
  geom_segment(aes(y = 4.2, yend = 4, x = 0.3, xend = 0.5),
               arrow = arrow(length = unit(0.02, "npc")), color = "#446E9B") +
  annotate("text", label = "moon + moon:cloud*0.5", x = 0.9, y = 4, hjust = 1, 
           color = "#D47500") +
  geom_segment(aes(y = 3.9, yend = 3.6, x = 0.65, xend = 0.7),
               arrow = arrow(length = unit(0.02, "npc")), color ="#D47500") +
  annotate("text", label = "moon + moon:cloud*1", x = 0.9, y = 3, hjust = 1, 
           color = "#3CB521") +
  geom_segment(aes(y = 2.9, yend = 2.63, x = 0.65, xend = 0.7),
               arrow = arrow(length = unit(0.02, "npc")), color ="#3CB521")
```
