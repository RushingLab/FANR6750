---
title: "LECTURE 7: statistical power"
...
knitr::include_graphics("fig/NHT.png")
```
...
```{r, echo = FALSE, out.height=450, out.width=800}
knitr::include_graphics("fig/NHT_reject.png")
```
...
```{r, echo = FALSE, out.height=450, out.width=800}
knitr::include_graphics("fig/NHT_ftr.png")
```
...
```{r, echo = FALSE, out.height=450, out.width=800}
knitr::include_graphics("fig/NHT_typeI.png")
```
...
```{r, echo = FALSE, out.height=450, out.width=800}
knitr::include_graphics("fig/NHT_alpha.png")
```
...
```{r, echo = FALSE, out.height=450, out.width=800}
knitr::include_graphics("fig/NHT_typeII.png")
```
...
```{r, echo = FALSE, out.height=450, out.width=800}
knitr::include_graphics("fig/NHT_q.png")
```
...
### **Reading**: [Fieberg chp. 3.7](https://statistics4ecologists-v3.netlify.app/03-multipleregression#sec-ancova)
