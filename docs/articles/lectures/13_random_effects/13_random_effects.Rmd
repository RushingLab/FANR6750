...
$$\large y_{ij} = \beta_0 + \beta_{1[j]} + \beta_{2} x_i + \epsilon_{ij}$$
$$\large \epsilon_{ij} \sim normal(0, \sigma^2)$$

- $y_{ij}$ = weight of chick $i$ in colony $j$
...
$$\large y_{ij} = \beta_0 + \beta_{1[j]} + \beta_{2} x_i + \epsilon_{ij}$$
$$\large \beta_{1[j]} \sim normal(0, \sigma^2_C)$$
...
$$\large H_0 : \beta_{1[1]} = \beta_{1[2]} = ... = \beta_{1[a]} = 0$$
