---
title: "Lab 4: Linear models with one categorical predictor-- t-tests"
...
3) Load the `FANR6750data` package and the `studentsdata` object
...
1) Load the `FANR6750data` package and the `thrushdata` object. Lets look at the structure and summary of the dataset as well
