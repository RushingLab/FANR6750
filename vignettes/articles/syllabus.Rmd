...
The Fieberg (2022) textbook can be accesses [here](https://fw8051statistics4ecologists.netlify.app/). Purchasing the Quinn (2002) textbook is not required but may be helpful for clarifying some concepts. A pdf of the book can be downloaded [here](https://www2.ib.unicamp.br/profs/fsantos/apostilas/Quinn%20&%20Keough.pdf).  
...
At the time each assignment is due, we will post an answer key on eLC. You will receive 2 points for reviewing your answers and correcting any incorrect answers based on the key. You will also receive 2 points for completing a self-assessment form describing your performance on the assignment and things you had trouble with. Self-assessment forms for each assignment will be posted on eLC. To receive full credit, corrections and self-assessments must be completed within one week.  
