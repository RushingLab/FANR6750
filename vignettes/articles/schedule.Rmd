...
schedule <- data.frame(WK = c("1", "", "", 
      ...
      "Labor Day", "Linear models for simple categorical predictors (aka t-test)", "Null hypothesis testing", "", # 4
       ...
       "Linear models for categorical predictor w/ >2 levels (aka ANOVA)", "Multiple comparisons", "Exam 1 review", "", #6
      "Multiple regression", "Multiple regression", "Paper discussion: multicollinearity", "", #7
