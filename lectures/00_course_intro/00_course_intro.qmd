...
::: {.column width="50%"}
Dr. Clark Rushing  
[clark.rushing@uga.edu](mailto:clark.rushing@uga.edu)  
**Office**: 3-409  
...
Anna Willoughby (M)  
[anna.willoughby@uga.edu](mailto:anna.willoughby@uga.edu)  
**Office**: Odum Rm. 140  
**Office hours**: W 3:30-5pm  

Alan Bond (Tu)  
[alan.bond1@uga.edu](mailto:alan.bond1@uga.edu)  
**Office**: 1-102  
**Office hours**: F 10:00-12:00  

Himasree Kolla (W)  
[himasree.kolla@uga.edu](mailto:himasree.kolla@uga.edu)  
**Office**: TBD  
**Office hours**: TBD  
:::
...
Lectures and labs: [rushinglab.github.io/FANR6750](https://rushinglab.github.io/FANR6750)^[Bookmark this page!]
...
- You can use your own laptop but make sure you have R and RStudio installed prior to the first lab^[See [here](https://rushinglab.github.io/FANR6750/articles/syllabus.html#course-resources-1) for instructions]
:::
...
- 3 lecture exams, 40 points (20%) each
    - In-class format using eLC/Lockdown Browser^[Remote students must take exams during class period in an approved setting]
...
- 1 point for completing both assessments (5 points total)
