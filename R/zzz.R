  ...
  theme_spacelab <- function(base_size = 12, base_family = "") {
    ...
    theme(
      ...
      # by others
      line = element_line(
        linewidth = 0.5, linetype = 1, colour = "black",
        lineend = "butt", color ="#f89406"
      ),
      rect = element_rect(fill = "transparent", colour = "black", linewidth = 0.5, linetype = 1),
      text = element_text(
      ...
      axis.ticks = element_line(linewidth = 0.2, color = "#999999"),
      ...
      legend.key = element_rect(fill = "transparent", colour = "#999999"),
      ...
      panel.border = element_rect(fill = "transparent", color = NA, linewidth = .5),
