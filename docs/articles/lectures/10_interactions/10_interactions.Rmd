...
$$E[voles] = \color{#D47500}{13.5} ^* 1 + \color{#D47500}{18.0}^*0 + \color{#D47500}{28.5}^*0 + \color{#D47500}{-2.5}^*1+\color{#D47500}{-8.25}^*0 + \color{#D47500}{-22.5}^*0=11.5$$
--
...
- Because there are 2 levels of predation and 4 levels of food supplementation, this is a $\large 2 \times 4$ factorial design  
...
- $\color{#D47500}{\beta_1}$ (i.e., `moon` ) = change in call rate per % change in moon **when cloud = 0**

--

Cloud = 100

$$\color{#D47500}{\beta_0} + (\color{#D47500}{\beta_1 + \beta_3}^*100)^*moon_i + \color{#D47500}{\beta_2}^*100$$

-  $\color{#D47500}{\beta_2}$ (i.e., `cloud`)=  change in call rate per % change in cloud **when moon = 0**

- $\color{#D47500}{\beta_3}$ (i.e., `moon:cloud`) = change in effect of moon per % change in cloud cover (or vice versa)
...
```{r fig.height = 6, fig.width = 8}
pred_df <- data.frame(a = c(2.582, (2.582-0.00228*50), (2.582-0.00228*100)),
                      b = c(0.027, (0.027-0.00024*50), (0.027-0.00024*100)),
                      cloud = factor(c("0", "50", "100"), levels = c("0", "50", "100")))
...
ggplot(chuckdata, aes(x = moon, y = call.rate)) +
  ...
  annotate("text", label = "Intercept", x = 0.01*100, y = 3.35, hjust = 0, 
           color = "#446E9B") +
  geom_segment(aes(y = 3.25, yend = 2.6, x = 0.025*100, xend = 0),
               arrow = arrow(length = unit(0.02, "npc")), color = "#446E9B") +
  annotate("text", label = "Intercept + cloud*50", x = 0.21*100, y = 2.65, hjust = 0, 
           color = "#D47500") +
  geom_segment(aes(y = 2.65, yend = 2.45, x = 0.2*100, xend = 0),
               arrow = arrow(length = unit(0.02, "npc")), color ="#D47500") +
  annotate("text", label = "Intercept + cloud*100", x = 0.21*100, y = 2, hjust = 0, 
           color = "#3CB521") +
  geom_segment(aes(y = 2, yend = 2.32, x = 0.2*100, xend = 0),
               arrow = arrow(length = unit(0.02, "npc")), color ="#3CB521") +
  annotate("text", label = "moon", x = 0.29*100, y = 4.22, hjust = 1, 
           color = "#446E9B") +
  geom_segment(aes(y = 4.2, yend = 4, x = 0.3*100, xend = 0.5*100),
               arrow = arrow(length = unit(0.02, "npc")), color = "#446E9B") +
  annotate("text", label = "moon + moon:cloud*50", x = 0.9*100, y = 4, hjust = 1, 
           color = "#D47500") +
  geom_segment(aes(y = 3.9, yend = 3.6, x = 0.65*100, xend = 0.7*100),
               arrow = arrow(length = unit(0.02, "npc")), color ="#D47500") +
  annotate("text", label = "moon + moon:cloud*100", x = 0.9*100, y = 3, hjust = 1, 
           color = "#3CB521") +
  geom_segment(aes(y = 2.9, yend = 2.63, x = 0.65*100, xend = 0.7*100),
               arrow = arrow(length = unit(0.02, "npc")), color ="#3CB521")
```
